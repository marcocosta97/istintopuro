...
const STR = {
  it: {
    ...
    about: "Solver per il gioco «Istinto Puro»: scegli una o più squadre e scopri all'istante tutti i giocatori che hanno giocato per tutte, ordinati per presenze combinate. C'è anche una schedina giornaliera: quattro sfide di difficoltà crescente, le stesse per tutti. Dati estratti da Wikidata.",
  ...
  en: {
    ...
    built: (d) => `updated ${d}`,
    about: "Solver for the game “Istinto Puro”: pick one or more clubs and instantly see every player who played for them all, ranked by combined appearances. There is also a daily quiz: four challenges of rising difficulty, the same for everyone. Data extracted from Wikidata.",
